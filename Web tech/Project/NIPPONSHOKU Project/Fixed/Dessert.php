...
<head>
  ...
  .product {
    display: grid;
    grid-template-rows: 1.3fr 1.3fr 1.3fr 0.5fr;
...
<body>
  <nav class="navbar navbar-expand-lg sticky-lg-top bg-black"
    ...
    <div class="flexbox">
      <div class="item">
        <a style="text-decoration:none" href="Sashimi.php">
          ...
          <div class="text"><p>SASHIMI</p></div>
        </a>
      </div>
      ...
      <div class="item-selected">
        <a style="text-decoration:none" href="Dessert.php">
          ...
          <div class="text"><p>DESSERT</p></div>
        </a>
      </div>
